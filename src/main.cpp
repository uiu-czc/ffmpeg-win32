...
static const FFMemberInfo avcodecctx_members[] = {
    ...
    MEMBER(AVCodecContext, mb_decision),
    ...
    MEMBER(AVCodecContext, stats_out),
    MEMBER(AVCodecContext, stats_in),
...
static const FFStructInfo g_structs[] = {
    ...
    { "AVOutputFormat", avoutputformat_members, (int)(sizeof(avoutputformat_members) / sizeof(FFMemberInfo)) },
    { "AVInputFormat", avinputformat_members, (int)(sizeof(avinputformat_members) / sizeof(FFMemberInfo)) }
};
